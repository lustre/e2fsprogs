...
#define LMAI_RELEASED	0x00000001
#define LMA_INCOMPAT_SUPP (LMAI_RELEASED)
#endif
...
extern int e2fsck_lfsck_check_lustre_version(char *buf, int buflen);
extern int e2fsck_lfsck_check_layout(e2fsck_t ctx, char *block_buf);
...
#else /* !HAVE_LFSCK */
#define e2fsck_lfsck_check_layout(ctx, block_buf) (0)
