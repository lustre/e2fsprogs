...
static struct ext2_dx_root_info *set_root_node(ext2_filsys fs,
					       char *buf,
					       ext2_ino_t ino,
					       ext2_ino_t parent,
					       struct ext2_dir_entry *dot_de,
					       struct ext2_dir_entry *dotdot_de)
{
	...
	rec_len	= EXT2_DIR_REC_LEN((struct ext2_dir_entry_2 *)dot_de);
	...
	rec_len = EXT2_DIR_REC_LEN((struct ext2_dir_entry_2 *)dotdot_de);
