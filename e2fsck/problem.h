...
#define PR_0_MIN_EXTRA_ISIZE_INVALID		0x000051

/* Invalid s_want_extra_isize */
#define PR_0_WANT_EXTRA_ISIZE_INVALID		0x000052

/* Clear EXT4_FEATURE_RO_COMPAT_EXTRA_ISIZE flag */
#define PR_0_CLEAR_EXTRA_ISIZE			0x000053
